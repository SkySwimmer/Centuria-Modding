...
using EarlyAccessPorts.AvatarScaleUnlocker.Patches.AssemblyCSharp;
using Il2CppInterop.Runtime.Injection;
using Newtonsoft.Json;
using UnityEngine;
using HarmonyLib;

namespace EarlyAccessPorts.AvatarScaleUnlocker
{
    public class AvatarScaleUnlockerMod : FeralTweaksMod
    {
        ...
        {
            FeralTweaksLoader.GetLoadedMod<AvatarScaleUnlockerMod>().LogInfo("Applying patch: " + type.FullName);
        ...
        {
            File.WriteAllText(FeralTweaksLoader.GetLoadedMod<AvatarScaleUnlockerMod>().ConfigDir + "/settings.props",
                  "\n");
        }
    }
}
