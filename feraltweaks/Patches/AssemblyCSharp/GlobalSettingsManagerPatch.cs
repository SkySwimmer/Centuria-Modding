...
namespace feraltweaks.Patches.AssemblyCSharp
{
    public static class GlobalSettingsManagerPatch 
    {
        ...
        {
            __result = FeralTweaks.PatchConfig.GetValueOrDefault("GameAssetsProd", "https://emuferal.ddns.net/feralassets/");
        }
        ...
        {
            __result = FeralTweaks.PatchConfig.GetValueOrDefault("GameAssetsStage", "https://emuferal.ddns.net/feralassetsstage/");
        }
        ...
        {
            __result = FeralTweaks.PatchConfig.GetValueOrDefault("GameAssetsDev", "https://emuferal.ddns.net/feralassetsdev/");
        }
        ...
        {
            __result = FeralTweaks.PatchConfig.GetValueOrDefault("GameAssetsShared", "https://emuferal.ddns.net/feralassets-s2/");
        }
        ...
        {
            __result = FeralTweaks.PatchConfig.GetValueOrDefault("GameAssetsStageShared", "https://emuferal.ddns.net/feralassetsstage-s2/");
        }
        ...
        {
            __result = FeralTweaks.PatchConfig.GetValueOrDefault("GameAssetsDevShared", "https://emuferal.ddns.net/feralassetsdev-s2/");
        }
    }
}