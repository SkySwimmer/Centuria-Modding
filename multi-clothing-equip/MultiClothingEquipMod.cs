...
using UnityEngine;
using HarmonyLib;
using EarlyAccessPorts.MultiClothingEquip.Patches;

namespace EarlyAccessPorts.MultiClothingEquip
{
    public class MultiClothingEquipMod : FeralTweaksMod
    {
        ...
        {
            FeralTweaksLoader.GetLoadedMod<MultiClothingEquipMod>().LogInfo("Applying patch: " + type.FullName);
        ...
        {
            File.WriteAllText(FeralTweaksLoader.GetLoadedMod<MultiClothingEquipMod>().ConfigDir + "/settings.props",
                  "AllowMultipleClothingItemsOfSameType=true\n");
        }
    }
}
