...
namespace FeralTweaks
{
    ...
    public static class FeralTweaksLoader
    {
        ...
        internal static void Start()
        {
            ...
            // Start action thread
            FeralTweaksActions.StartActionThread();
        ...
        /// <summary>
        /// Called to set up Unity itself
        /// </summary>
        internal static void SetupUnity()
        {
            // Create update handler
            ClassInjector.RegisterTypeInIl2Cpp<FrameUpdateHandler>();
            GameObject obj = new GameObject();
            obj.name = "~FTL_AM";
            obj.hideFlags = HideFlags.HideAndDontSave;
            FrameUpdateHandler handler = obj.AddComponent<FrameUpdateHandler>();
            GameObject.DontDestroyOnLoad(obj);
            FeralTweaksActions.SetupUpdateHandler(handler);

            // Setup
            FeralTweaksActions.SetupUnity();
            ...
            if (Bootstrap.logUnityToConsole || Bootstrap.logUnityToFile)
            {
                try
                {
                    ...
                    else if (Bootstrap.logUnityToConsole && !Bootstrap.logUnityToFile)
                    ...
                    objC.hideFlags = HideFlags.HideAndDontSave;
    ...
    internal class FrameUpdateHandler : UnityEngine.MonoBehaviour
    {
        public FrameUpdateHandler() { }
        public FrameUpdateHandler(IntPtr ptr) : base(ptr) {}

        public void Update()
        {
            // Done via low-level patch to avoid exception loss
        }
    }
