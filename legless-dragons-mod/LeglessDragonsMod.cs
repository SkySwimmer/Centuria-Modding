...
namespace EarlyAccessPorts.LeglessDragons
{
    public class LeglessDragonsMod : FeralTweaksMod
    {
        ...
        {
            // Patches
            feraltweaks.FeralTweaks.Patches[File.ReadAllText(ModBaseDirectory + "/no_legs_define.cdpf").Replace("\t", "    ").Replace("\r", "")] = "no_legs_define.cdpf";
            feraltweaks.FeralTweaks.Patches[File.ReadAllText(ModBaseDirectory + "/no_legs_merge.cdpf").Replace("\t", "    ").Replace("\r", "")] = "no_legs_merge.cdpf";
        }

        public static void ApplyPatch(Type type)
        {
            FeralTweaksLoader.GetLoadedMod<LeglessDragonsMod>().LogInfo("Applying patch: " + type.FullName);
        ...
        {
            File.WriteAllText(FeralTweaksLoader.GetLoadedMod<LeglessDragonsMod>().ConfigDir + "/settings.props",
                  "\n");
        }
    }
}
