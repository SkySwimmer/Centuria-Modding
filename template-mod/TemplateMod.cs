...
namespace EarlyAccessPorts.Template
{
    public class TemplateMod : FeralTweaksMod
    {
        ...
        {
            FeralTweaksLoader.GetLoadedMod<TemplateMod>().LogInfo("Applying patch: " + type.FullName);
        ...
        {
            File.WriteAllText(FeralTweaksLoader.GetLoadedMod<TemplateMod>().ConfigDir + "/settings.props",
                  "\n");
        }
    }
}
